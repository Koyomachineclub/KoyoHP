<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><title>Using YUIDoc</title><link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Maven+Pro:400,700"><link rel="stylesheet" href="http://yui.yahooapis.com/3.4.1/build/cssgrids/grids-min.css"><link rel="stylesheet" href="../assets/css/main.css"><link rel="stylesheet" href="../assets/vendor/prettify/prettify-min.css"><link rel="shortcut icon" type="image/png" href="../assets/favicon.png"><script src="http://yui.yahooapis.com/3.5.1/build/yui/yui.js"></script></head><body><a href="https://github.com/yui/yuidoc"><img style="position: absolute; top: 0; right: 0; border: 0" src="https://s3.amazonaws.com/github/ribbons/forkme_right_darkblue_121621.png" alt="Fork me on GitHub"></a><div id="doc"><div id="hd"><h1><img src="http://yuilibrary.com/img/yui-logo.png">Using YUIDoc</h1></div><div class="crumbs"><a href="../">Main Page</a> <a name="Arrow">&gt;</a> <a href="../args/index.html">Using YUIDoc</a></div><a href="#toc" class="jump">Jump to Table of Contents</a><div class="yui3-g"><div class="yui3-u-3-4"><div id="main"><div class="content"><p>Generating documentation with YUIDoc is as simple as going to the top of your source tree and running:</p><pre class="code terminal"><span class="noselect">$ </span>yuidoc .</pre><p>However, you can configure YUIDoc's behavior further by providing <a href="#command-line">command line options</a>, a <a href="#json">JSON configuration file</a>, or even both. This section discusses the <code>yuidoc</code> command line tool in more detail.</p><h2 id="command-line">Running YUIDoc on the Command Line</h2><p>Certain <code>yuidoc</code> command line options correspond to entries in the the <a href="#json"><code>yuidoc.json</code> configuration file</a>. Command line options always take priority.</p><pre class="code terminal">YUI Doc generates API documentation from a modified JavaDoc syntax.
...
}</pre>See below for <a href="#ex-yui3">more</a> <a href="#ex-yuidoc">examples</a>.<h3 id="yuidocjson-fields">yuidoc.json Fields</h3><h4 id="general-yuidoc-project-information">General YUIDoc Project Information</h4><table><tr><th>Name</th><th>Description</th></tr><tr><td><code>name</code></td><td>A short name for the project.</td></tr><tr><td><code>description</code></td><td>A one or two sentence description of the project.</td></tr><tr><td><code>version</code></td><td>The project's current version, as some kind of meaningful string.</td></tr><tr><td><code>url</code></td><td>The project's primary URL. This does not necessarily have to be the URL of the generated API documentation.</td></tr><tr><td><code>logo</code></td><td>The logo to add to the header of all generated HTML documentation. If you do not provide a header, YUIDoc will use the YUI logo by default.</td></tr></table><h4 id="yuidoc-options">YUIDoc Options</h4><p>Within the <code>options</code> object, you can provide any of the following fields:</p><table><tr><th>Name</th><th>Description</th></tr><tr><td><code>linkNatives</code></td><td>Selects whether to autolink native types such as <code>String</code> and <code>Object</code> over to the Mozilla Developer Network.</td></tr><tr><td><code>attributesEmit</code></td><td>Selects whether YUIDoc should autogenerate documentation for change events generated by the <a href="http://yuilibrary.com/yui/docs/api/classes/Attribute.html">YUI Attribute API</a>. When a YUI attribute <code>foo</code> changes its value, YUI automatically fires a custom event named <code>fooChange</code>. Setting <code>attributesEmit</code> to <code>true</code> instructs YUIDoc to automatically generate documentation for each of these events. You can set this value to <code>false</code> if you think that your audience is well aware of change events and would not benefit from this extra verbiage.</td></tr><tr><td><code>selleck</code></td><td>Selects whether to add <a href="http://rgrove.github.com/selleck/">Selleck</a> metadata. If <code>true</code>, YUIDoc searches for a <code>component.json</code> file above the source tree and attaches that data to the module data as extra information.</td></tr><tr><td><code>ignorePaths</code></td><td>Specifies an array of string paths to ignore when using shell globbing. This only removes top level items from the list to initally scan. Use <code>exclude</code> to remove specific directories.</td></tr><tr><td><code>exclude</code></td><td>Specify a comma separated list of names you want to exclude from parses when YUIDoc recurses the source tree.</td></tr><tr><td><code>paths</code></td><td>Specifies a single string <code>glob</code> or array of globs to use when searching the source tree for docs to parse.</td></tr><tr><td><code>outdir</code></td><td>Specifies the directory in which to place the rendered HTML files and assets.</td></tr><tr><td><code>tabtospace</code></td><td>Specifies the number of spaces each tab character in source code should be converted to when using YUIDoc's source code view. The default is 8.</td></tr><tr><td><code>external.data</code></td><td>Provides a link to an external <code>data.json</code> file to merge into the local api docs. For more information, refer to the <a href="#external-data">external data example</a>.</td></tr><tr><td><code>markdown</code></td><td>Options to pass to Marked, the Markdown compiler used to compile API descriptions. See the <a href="https://github.com/chjj/marked#options">Marked readme</a> for details.</td></tr></table><h3 id="ex-yui3">Example: YUI 3 Library API</h3><p>This sample <code>yuidoc.json</code> file is used in the <a href="http://yuilibrary.com/">YUI 3</a> project:</p><pre class="code prettyprint">{
    &quot;name&quot;: &quot;YUI 3&quot;,
...
}</pre><h3 id="ex-yuidoc">Example: YUIDoc API</h3><p>This sample <code>yuidoc.json</code> file is used in the YUIDoc project itself:</p><pre class="code prettyprint">{
  &quot;name&quot;: &quot;YUIDoc&quot;,
